  ...
  #makeModal() {
    ...
    const modalHtml = ` <div class="pop-header">${this.options.header || ""}</div>
                            <button class="modal_btn btn-layerPop-close modalCancelIcon_content" type="button" id="">
                                <img src="https://image.daedamo.com/images/img/renew/i_close_black.svg" alt="닫기 이미지"/>
                            </button>
...
const _showDiscussionModal = async (data) => {
  return new Promise((resolve) => {
    ...
    discussionModal.showModal({
      doWhat: "done",
      title: `<img src="https://image.daedamo.com/images/img/renew/discussion_guide/i_discuttion_modal_2.png"/>
      ...
      <ul class="bd-modal-list">
        <li>
          <div class="bd-modal-img-wrap">
            <img src="https://image.daedamo.com/images/img/renew/icon/2026/i_photo_review.svg" alt=""/>
          </div>
        ...
        <li>
          <div class="bd-modal-img-wrap">
            <img src="https://image.daedamo.com/images/img/renew/icon/2026/i_talk_talk.svg" alt=""/>
          </div>
          <div class="bd-modal-info">
        ...
        <li>
          <div class="bd-modal-img-wrap">
            <img src="https://image.daedamo.com/images/img/renew/icon/2026/i_level.svg" alt=""/>
          </div>
          <div class="bd-modal-info">
  ...
  const content = `
    <div class="jp-card" data-view="main">
      ...
      <div class="jp-view jp-view--main">
        ...
        <div class="jp-coupon">
          <img class="jp-coupon-img" src="https://image.daedamo.com/images/img/renew/event/202605_jp_event/amazon_gift.png" alt="Amazon Gift Card"/>
