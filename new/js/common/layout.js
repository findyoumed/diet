  ...
  if (filter === "login") {
        ...
        ${
          langCode === "ja"
            ...
            <div class="flex btn common-btn-line-login">
              <img src="https://image.daedamo.com/images/img/renew/icon/i_line.svg" alt="LINE">
              ${$.i18n("common.sign.lineLogin")}
            </div>
            `
            : `
            <div class="flex btn btn-kakao-join">
              <img src="https://image.daedamo.com/images/img/renew/icon/i_login_kakao.png" alt="${$.i18n("common.text.kakao")}">
              ${$.i18n("common.sign.kakao")}
            </div>
          `
        }
          <a href="/new/bbs/login.php?hl=${langCode}&url=${loginCallbackUrl}" class="register_email">
            <img src="https://image.daedamo.com/images/img/renew/icon/i_login_email.png" alt="${$.i18n("common.register.startEmail")}">
    ...
    popHtml = `
      <div class="hlist-popup">
        <div class="txt">
          <h3>
            <img src="https://image.daedamo.com/images/img/renew/icon/2025/i_notice_circle.svg" alt=""> ${$.i18n("common.text.guide")}
          </h3>
