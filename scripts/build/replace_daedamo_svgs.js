...
for (let file of files) {
    ...
    content = content.replace(/https:\/\/image\.daedamo\.com\/images\/staticBanner\/etc\/talmo_help_icon_ko\.svg/g, 'images/custom/dieton_help_icon.svg');
    
    // Replace i_daedamo_pick_balloon.svg
    content = content.replace(/https:\/\/image\.daedamo\.com\/images\/img\/renew\/icon\/i_daedamo_pick_balloon\.svg/g, 'images/custom/dieton_pick_balloon.svg');
...
console.log('Replaced specific daedamo svg tags with DietOn custom SVGs and busted cache.');
