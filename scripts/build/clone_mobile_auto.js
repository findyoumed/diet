...
const inFile = 'd:\\work\\다이어트\\dieton_mobile_raw.html';
const outFile = 'd:\\work\\다이어트\\index_mobile.html';

if (!fs.existsSync(inFile)) {
    console.error('dieton_mobile_raw.html not found!');
    process.exit(1);
}
...
// 2. Logo Replacements
content = content.replace(/https:\/\/image\.dieton\.com\/images\/logo\/logo_dieton_i_black_ko\.png/g, 'images/custom/logo.svg');
content = content.replace(/https:\/\/image\.dieton\.com\/images\/logo\/dieton_now_mobile_ko\.svg/g, 'images/custom/dieton_now.svg'); // Just a fake generated one

// 3. Common Image Replacements (matching our previous changes)
content = content.replace(/https:\/\/image\.dieton\.com\/images\/staticBanner\/etc\/talmo_help_icon_ko_2026\.svg/g, 'images/custom/dieton_help_icon.svg');
content = content.replace(/https:\/\/image\.dieton\.com\/images\/staticBanner\/ad_search_pop_banner_mo_ko\.jpg/g, 'images/custom/right_small_banner.svg');
